...
const EntertainmentCardSlider = () => {
  const EntertainmentImage = [
    "https://assets-in.bmscdn.com/discovery-catalog/collections/tr:w-800,h-800:l-text,ie-NTArIEV2ZW50cw%3D%3D,co-FFFFFF,ff-Roboto,fs-64,lx-48,ly-320,tg-b,pa-8_0_0_0,l-end:w-300/workshop-and-more-web-collection-202211140440.png",
    ...
    "https://assets-in.bmscdn.com/discovery-catalog/collections/tr:w-800,h-800:l-text,ie-NzArIEV2ZW50cw%3D%3D,co-FFFFFF,ff-Roboto,fs-64,lx-48,ly-320,tg-b,pa-8_0_0_0,l-end:w-300/theatre-shows-collection-202211140440.png",
    "https://assets-in.bmscdn.com/discovery-catalog/collections/tr:w-800,h-800:l-text,ie-OCBFdmVudHM%3D,co-FFFFFF,ff-Roboto,fs-64,lx-48,ly-320,tg-b,pa-8_0_0_0,l-end:w-300/adventure-fun-collection-202211140440.png",
  ];
  ...
  const settings = {
    ...
    responsive: [
      {
        breakpoint: 1024,
        // instead of making different settings for small , medium and large we can do it like this and create responsive design
        settings: {
          slidesToShow: 3,
          slidesToScroll: 2,
        },
  ...
  return (
    <>
      ...
      <Slider {...settings}>
         {/* we will map each image and send it to make it in a card */}
        {EntertainmentImage.map((image, index) => (
          <EntertainmentCard src={image} key={index} />
          // calling our component so that we can get the final card based on each image 
        ))}
      </Slider>
